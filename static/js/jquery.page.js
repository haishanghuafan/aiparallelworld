...
(function ($) {
  ...
  $.fn.Page = function (options) {
    ...
    return this.each(function () {
      ...
      var str = '';
        var str1 = '<li><a href="javascript:" class="' + (pageindex==1? active:"") +'">1</a></li>';
      if (l > 1&&l < n+1) {
        for (i = 2; i < l + 1; i++) {
            str += '<li><a href="javascript:"  class="' + (pageindex == i ? active : "") +'">' + i + '</a></li>';
        }
      }else if(l > n){
        for (i = 2; i < n + 1; i++) {
            str += '<li><a href="javascript:"  class="' + (pageindex == i ? active : "") +'">' + i + '</a></li>';
      ...
      //}
        dataHtml += '<ul class="pager">' + str1 + str + '</ul>';
